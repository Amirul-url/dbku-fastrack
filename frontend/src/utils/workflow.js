...
export const AD_LICENSE_FLOW = [
  ...
  },
  {
    ...
    phase: "Penyelesaian",
    phaseEn: "Completion",
    title: "Jana invois, bayaran FPX/kad, verifikasi bayaran dan muat turun e-lesen QR",
    titleEn: "Generate invoice, FPX/card payment, payment verification, and QR e-license download",
    targetDays: 2,
