...
function AdminStep7Page() {
  ...
  async function handleSaveStep7() {
    ...
    try {
      ...
      navigate(`/admin/applications/${applicationId}/step-8?id=${applicationId}`);
...
function PageActions({ applicationId, onSave }) {
  return (
    <div className="flex gap-2">
      <Link
        to={`/admin/applications/${applicationId}/step-6?id=${applicationId}`}
