...
function AdminStep8Page() {
  ...
  async function handleSaveStep8() {
    if (!applicationId) {
    ...
    try {
      ...
      navigate(`/admin/applications/${applicationId}/step-9?id=${applicationId}`);
    } catch (err) {
      console.error("Step 8 save failed:", err);
  ...
  return (
    <Layout>
      <div className="flex gap-4">
        <AdminApplicationStepNav active={8} />
        ...
        <main className="flex-1 min-w-0">
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Link
                to={`/admin/applications/${applicationId}/step-7?id=${applicationId}`}
