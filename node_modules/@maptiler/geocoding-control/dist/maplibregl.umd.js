 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function zr(i,e){return(t,r,s)=>{const n=o=>o.renderRoot?.querySelector(i)??null;return Wr(t,r,{get(){return n(this)}})}}var qr=Object.getOwnPropertyDescriptor,Hr=(i,e,t,r)=>{for(var s=r>1?void 0:r?qr(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=o(s)||s);return s};$.MaptilerGeocodeClearIconElement=class extends ne{render(){return qe`
  ...
  `,$.MaptilerGeocodeClearIconElement=Hr([_e("maptiler-geocode-clear-icon")],$.MaptilerGeocodeClearIconElement);var jr=Object.getOwnPropertyDescriptor,Vr=(i,e,t,r)=>{for(var s=r>1?void 0:r?jr(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=o(s)||s);return s};$.MaptilerGeocodeFailIconElement=class extends ne{render(){return qe`
  ...
  `,$.MaptilerGeocodeFailIconElement=Vr([_e("maptiler-geocode-fail-icon")],$.MaptilerGeocodeFailIconElement);var Zr=Object.getOwnPropertyDescriptor,Kr=(i,e,t,r)=>{for(var s=r>1?void 0:r?Zr(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=o(s)||s);return s};$.MaptilerGeocodeLoadingIconElement=class extends ne{render(){return Z`
      <div>
  ...
  `,$.MaptilerGeocodeLoadingIconElement=Kr([_e("maptiler-geocode-loading-icon")],$.MaptilerGeocodeLoadingIconElement);var Yr=Object.getOwnPropertyDescriptor,Xr=(i,e,t,r)=>{for(var s=r>1?void 0:r?Yr(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=o(s)||s);return s};$.MaptilerGeocodeReverseGeocodingIconElement=class extends ne{render(){return qe`
  ...
  `,$.MaptilerGeocodeReverseGeocodingIconElement=Xr([_e("maptiler-geocode-reverse-geocoding-icon")],$.MaptilerGeocodeReverseGeocodingIconElement);var Qr=Object.getOwnPropertyDescriptor,Jr=(i,e,t,r)=>{for(var s=r>1?void 0:r?Qr(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=o(s)||s);return s};$.MaptilerGeocodeSearchIconElement=class extends ne{render(){return qe`
      <svg
 ...
 */const Ri="important",vs=" !"+Ri,bs=Ut(class extends Ft{constructor(i){if(super(i),i.type!==Gt.ATTRIBUTE||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce(((e,t)=>{const r=i[t];return r==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`}),"")}update(i,[e]){const{style:t}=i.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?t.removeProperty(r):t[r]=null);for(const r in e){const s=e[r];if(s!=null){this.ft.add(r);const n=typeof s=="string"&&s.endsWith(vs);r.includes("-")||n?t.setProperty(r,n?s.slice(0,-11):s,n?Ri:""):t[r]=s}}return be}}),Es=".sprite-icon{align-self:center;justify-self:center;opacity:.75;background-repeat:no-repeat}li{text-align:left;cursor:default;display:grid;grid-template-columns:40px 1fr;color:var(--color-text);padding:8px 0;font-size:14px;line-height:18px;min-width:fit-content;outline:0}li:first-child{padding-top:10px}li:last-child{padding-bottom:10px}li.picked{background-color:#e7edff}li.picked .secondary{color:#96a4c7;padding-left:4px}li.picked .line2{color:#96a4c7}li.selected{background-color:#f3f6ff;animation:backAndForth 5s linear infinite}li.selected .primary{color:#2b8bfb}li.selected .secondary{color:#a2adc7;padding-left:4px}li.selected .line2{color:#a2adc7}li>img{align-self:center;justify-self:center;opacity:.75}.texts{padding:0 17px 0 0}.texts>*{white-space:nowrap;display:block;min-width:fit-content}.primary{font-weight:600}.secondary{color:#aeb6c7;padding-left:4px}.line2{color:#aeb6c7}@keyframes backAndForth{0%{transform:translate(0)}10%{transform:translate(0)}45%{transform:translate(calc(-100% + 270px))}55%{transform:translate(calc(-100% + 270px))}90%{transform:translate(0)}to{transform:translate(0)}}";var ws=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,Gi=i=>{throw TypeError(i)},pe=(i,e,t,r)=>{for(var s=r>1?void 0:r?xs(e,t):e,n=i.length-1,o;n>=0;n--)(o=i[n])&&(s=(r?o(e,t,s):o(s))||s);return r&&s&&ws(e,t,s),s},Ui=(i,e,t)=>e.has(i)||Gi("Cannot "+t),z=(i,e,t)=>(Ui(i,e,"read from private field"),t?t.call(i):e.get(i)),Ss=(i,e,t)=>e.has(i)?Gi("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(i):e.set(i,t),Ue=(i,e,t)=>(Ui(i,e,"access private method"),t),B,mt,Ke,Y,Fi,Bi,Dt,Wt;const Di=typeof devicePixelRatio>"u"||devicePixelRatio>1.25,Wi=Di?"@2x":"",Fe=Di?2:1;let Ie,zi,oe=class extends ne{constructor(){super(...arguments),Ss(this,B),this.itemStyle="default",this.showPlaceType="if-needed",this.missingIconsCache=new Set,this.iconsBaseUrl="",this.index=0}willUpdate(i){i.has("feature")&&z(this,B,mt)&&(this.index=z(this,B,mt).length,Ue(this,B,Dt).call(this))}render(){return Z`
      ...
      >
        ${Ie&&this.spriteIcon?Z`
              <div
                class="sprite-icon"
                style=${bs({width:`${this.spriteIcon.width/Fe}px`,height:`${this.spriteIcon.height/Fe}px`,backgroundImage:`url(${this.iconsBaseUrl}sprite${Wi}.png)`,backgroundPosition:`-${this.spriteIcon.x/Fe}px -${this.spriteIcon.y/Fe}px`,backgroundSize:`${Ie.width/Fe}px ${Ie.height/Fe}px`})}
                title=${z(this,B,Y)}
              />
            `:this.imageUrl?Z` <img src=${this.imageUrl} alt=${this.category} title=${z(this,B,Y)} @error=${Ue(this,B,Bi)} />`:this.feature?.address?Z` <img src=${this.iconsBaseUrl+"housenumber.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:this.feature?.id.startsWith("road.")?Z` <img src=${this.iconsBaseUrl+"road.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:this.feature?.id.startsWith("address.")?Z` <img src=${this.iconsBaseUrl+"street.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:this.feature?.id.startsWith("postal_code.")?Z` <img src=${this.iconsBaseUrl+"postal_code.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:this.feature?.id.startsWith("poi.")?Z` <img src=${this.iconsBaseUrl+"poi.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:z(this,B,Ke)?Z` <img src=${this.iconsBaseUrl+"reverse.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `:Z` <img src=${this.iconsBaseUrl+"area.svg"} alt=${z(this,B,Y)} title=${z(this,B,Y)} /> `}

        <span class="texts">
          <span>
            <span class="primary"> ${z(this,B,Ke)?this.feature?.place_name:this.feature?.place_name.replace(/,.*/,"")} </span>

            ${this.showPlaceType==="always"||this.showPlaceType!=="never"&&!this.feature?.address&&!this.feature?.id.startsWith("road.")&&!this.feature?.id.startsWith("address.")&&!this.feature?.id.startsWith("postal_code.")&&(!this.feature?.id.startsWith("poi.")||!this.imageUrl)&&!z(this,B,Ke)?Z` <span class="secondary"> ${z(this,B,Y)} </span> `:V}
          </span>

          <span class="line2"> ${z(this,B,Ke)?this.feature?.text:this.feature?.place_name.replace(/[^,]*,?s*/,"")} </span>
        </span>
      </li>
      ...
      <form @submit=${I(this,C,Vt)} class=${ft({"can-collapse":this.collapsed&&this.searchValue===""})}>
        <div class="input-group">
          ...
          <div class="clear-button-container ${ft({displayable:this.searchValue!==""})}">
            ${le(this,C,Hi)?Z`<maptiler-geocode-loading-icon></maptiler-geocode-loading-icon>`:Z`
                  <button type="button" @click=${I(this,C,Ji)} title=${this.clearButtonTitle??"clear"}>
                    <maptiler-geocode-clear-icon></maptiler-geocode-clear-icon>
                  </button>
                `}
          </div>

          ${this.enableReverse==="button"?Z`
                <button
                  type="button"
        ...
        ${this.error?Z`
            ...
            `:!this.focused&&!this.isFeatureListInteractedWith&&!this.keepListOpen||this.listFeatures===void 0?V:this.listFeatures.length===0?Z`
                ...
                `:Z`
                  <ul
                    class="options ${ft({"open-on-top":this.openListOnTop})}"
                    @pointerleave=${I(this,C,Yi)}
                    @pointerdown=${I(this,C,Xi)}
                    @pointerup=${I(this,C,Qi)}
                    @keydown=${I(this,C,Xt)}
                    role="listbox"
                  >
                    ${ms(this.listFeatures,e=>e.id+(e.address?","+e.address:""),(e,t)=>Z`
